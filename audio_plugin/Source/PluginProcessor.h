...
/**
*/
class Audio_pluginAudioProcessor  : public juce::AudioProcessor
...
public:
    ...
    ~Audio_pluginAudioProcessor() override;
    ...
    juce::AudioParameterFloat* ladderFilterCutOffFreqHz = nullptr;
